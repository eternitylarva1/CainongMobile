...
public class RuneOctahedron extends CustomRelic {
    public static final String ID = cainongmod.makeId("RuneOctahedron");
    public static final String IMG_PATH = cainongmod.getResourcePath("relics/runeOctahedron.png");

    public RuneOctahedron() {
        super(cainongmod.MOD_ID, ID, IMG_PATH, RelicTier.RARE, LandingSound.SOLID);
        this.counter = 0;
    }
