...
public class PaiDianDian extends CustomCard {
    public static final String ID = ModHelper.MakePath("PaiDianDian");
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID); // 从游戏系统读取本地化资源
    // private static final String NAME = "打击";
    private static final String NAME = CARD_STRINGS.NAME; // 读取本地化的名字
    private static final String IMG_PATH = "CaiNongModResources/img/cards/PaiDianDian.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(m, p, new NongHeiPower(m , 1)));
    }

    @Override
    public AbstractCard makeCopy() {
        return new PaiDianDian();
    }
}