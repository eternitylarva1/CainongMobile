...
public class TrancePower extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID =  cainongmod.makeId("TrancePower");
    // 能力的本地化字段
    ...
    public TrancePower(AbstractCreature owner, int Amount) {
        ...
        // 添加一大一小两张能力图
        String path128 = "cainongmodResources/img/powers/TrancePower84.png";
        String path48 = "cainongmodResources/img/powers/TrancePower32.png";
    ...
    public void atStartOfTurn() {
        ...
        if (p.hasRelic(RegalPillow.ID)) {heal += 15;}
        if (p.hasRelic(DreamCatcher.ID)) {
