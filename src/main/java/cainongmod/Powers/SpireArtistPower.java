...
public class SpireArtistPower extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID =  cainongmod.makeId("SpireArtistPower");
    // 能力的本地化字段
    ...
    public SpireArtistPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        ...
        // 添加一大一小两张能力图
        String path128 = "powers/SpireArtistPower84.png";
        String path48 = "powers/SpireArtistPower32.png";
    ...
    public void atEndOfTurn(boolean isPlayer) {
        ...
        if (this.amount == 0) {
            ...
            this.addToBot(new RemoveSpecificPowerAction(p, p, SpireArtistPower.POWER_ID));
