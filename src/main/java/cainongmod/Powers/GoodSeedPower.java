...
public class GoodSeedPower extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID =  cainongmod.makeId("GoodSeedPower");
    // 能力的本地化字段
    ...
    public GoodSeedPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void atStartOfTurn() {
        ...
        if (this.amount == 0) {
            ...
            this.addToBot(new RemoveSpecificPowerAction(p, p, GoodSeedPower.POWER_ID));
        }
    }
