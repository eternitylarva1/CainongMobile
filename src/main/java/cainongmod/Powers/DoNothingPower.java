...
public class DoNothingPower extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID =  cainongmod.makeId("DoNothingPower");
    // 能力的本地化字段
    ...
    public DoNothingPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        ...
        if (!isUseCard) {
            this.addToBot(new AbstractGameAction() {
                ...
                public void update() {
                    ...
                    this.addToBot(new RemoveSpecificPowerAction(p, p, DoNothingPower.POWER_ID));
                    this.isDone = true;
                }
            });
        }
