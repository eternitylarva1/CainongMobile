...
public class NongdialPower extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID =  cainongmod.makeId("NongdialPower");
    // 能力的本地化字段
    ...
    public NongdialPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        ...
        // 添加一大一小两张能力图
        String path128 = "cainongmodResources/img/powers/NongdialPower84.png";
        String path48 = "cainongmodResources/img/powers/NongdialPower32.png";
